...
const SignUpScreen = ({navigate}) => {
  ...
  return (
   ...
   <Text className='text-lg font-semi-bold mt-4'>Full Name</Text>
   ...
   <View>   
    ...
    <View className='flex-row'>
    <View>   
      <TextInput className='mt-1 w-64 h-6'
        placeholder="Type here"
    ...
    <View>   
      ...
      <View>
    <Text className='text-lg font-semi-bold mt-4'> Confirm Password </Text>
    <View className='flex-row'>
    <View>   
      <TextInput className='h-6 w-64'
        placeholder="Password"
      ...
      <View  className='flex-row mt-8'>
       <ToggleButton/>
      <Text className=' ml-px opacity-30 '>By creating an account you would have to agree {'\n'}   with our terms and conditions </Text>
      </View>
      <TouchableOpacity 
       onPress={() => {
      ...
      className='bg-black rounded-3xl w-80 h-10 ml-4 mt-8'>
        <Text className='text-white ml-32 text-lg mt-1.5'> Sign Up</Text >
      </TouchableOpacity>
